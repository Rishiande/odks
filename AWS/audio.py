...
forms = {
    ...
    "Server 3": {
        ...
        "Sai Madurai": {
            ...
            "192-Madurai South Landscape Survey 05-2025":{"project_id":13,"form_id":"192-Madurai South Landscape Survey 05-2025","ur":"https://tnodk03.indiaintentions.com/v1/projects/13/forms/192-Madurai%20South%20Landscape%20Survey%2005-2025.svc"},
...
def download_all_audio(server, start_date, end_date):
    """Download all audio files from all projects and forms"""
    config = ODK_CONFIGS[server]
        ...
        with zipfile.ZipFile(zip_buffer, "w", zipfile.ZIP_DEFLATED) as zipf:
            ...
            for project in projects:
                ...
                for form in forms:
                    ...
                    if not submissions:
                        status_messages.append(f"⚠️ No submissions in {form_name} ({project_name})")
                        continue
    ...
    zip_buffer.seek(0)
    return zip_buffer, status_messages, total_files
            ...
            if st.button("🚀 Download All Audio Files Automatically"):
                ...
                if file_count > 0:
                    ...
                    st.download_button(
                        ...
                        zip_file.getvalue(),
                        f"{selected_server}_audio_{datetime.now().strftime('%Y%m%d')}.zip",
                        "application/zip"
                    )
                else:
